    ...
    <div className="min-h-screen bg-elite-bg">
      ...
      <div className="relative h-[70vh] lg:h-[80vh] w-full">
        <div className="absolute inset-0">
          <Image
            src="/images/texture-illustration-banknote-consisting-many-260nw-2478669103.webp"
            fill
            className="object-cover"
            alt="Euro Bills Background"
            priority
          />
      ...
      <div className="prose max-w-6xl mx-auto  p-4 sm:p-6 lg:p-8">
        {[
          {
            title: "Counterfeit Money / GBP Counterfeit Banknotes",
            content: `GBP Counterfeit Banknotes are currencies produced without the legal sanction of a state or government...`,
          },
          {
            title: "Effects / Penalties of Using GBP Counterfeit Banknotes",
            ...
            {[
              {
                ...
                description: "All bills are verified for quality",
                icon: "🌟",
              },
              {
                title: "Fast Delivery",
